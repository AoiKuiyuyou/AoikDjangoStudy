...
trace_specs = [
    ...
    # ----- django -----
    ('django[.](.+)[.]process_request', {HL, 'hide_below'}),

    ('django[.](.+)[.]process_response', {HL, 'hide_below'}),

    ('django[.](.+)[.]process_view', {HL, 'hide_below'}),

    # Ignore to avoid error
    ('django.apps.registry.Apps.get_models', False),

    ('django.apps.registry.Apps.populate', HL, 'hide_below'),

    # Ignore to avoid error
    ('django.conf.BaseSettings.__setattr__', False),

    # Ignore to avoid error
    ('django.conf.LazySettings.__setattr__', False),

    # Ignore to avoid error
    ('django.conf.LazySettings._setup', False),

    # Ignore to avoid error
    ('django.conf.Settings.__setattr__', False),

    ('django.contrib.admin([.].+)?', False),

    (
        'django.contrib.staticfiles.management.commands.runserver'
        '.Command.get_handler', HL
    ),
    ...
    ('django.core.checks([.].+)?', False),

    ('django.core.files([.].+)?', False),

    ('django.core.handlers.base.BaseHandler.__init__', HL),

    ('django.core.handlers.base.BaseHandler.get_response', HL),

    ('django.core.handlers.base.BaseHandler.load_middleware', HL),

    ('django.core.handlers.wsgi.WSGIHandler.__init__', HL),

    ('django.core.handlers.wsgi.WSGIRequest.__init__', HL),

    ('django.core.handlers.wsgi.WSGIRequest.__setattr__', False),

    ('django.core.handlers.wsgi.WSGIRequest.get_full_path', False),

    ('django.core.management.base.BaseCommand.check', HL),

    ('django.core.management.base.BaseCommand.check_migrations', HL),

    ('django.core.management.base.BaseCommand.create_parser', HL),

    ('django.core.management.base.BaseCommand.execute', HL),

    ('django.core.management.base.BaseCommand.run_from_argv', HL),

    ('django.core.management.base.CommandParser.__init__', HL),

    ('django.core.management.base.CommandParser.add_argument', [
        HL, 'hide_below'
    ]),

    ('django.core.management.base.CommandParser.parse_args', HL),

    ('django.core.management.base.CommandParser.parse_known_args', [
        HL, 'hide_below'
    ]),

    ('django.core.management.base.CommandParser._get_args', False),

    ('django.core.management.base.CommandParser._get_handler', False),

    ('django.core.management.base.CommandParser._get_kwargs', False),

    ('django.core.management.base.handle_default_options', HL),

    ('django.core.management.commands.runserver.Command.execute', HL),

    ('django.core.management.commands.runserver.Command.get_handler', HL),

    ('django.core.management.commands.runserver.Command.inner_run', HL),

    ('django.core.management.execute_from_command_line', HL),

    ('django.core.management.get_commands', HL),

    ('django.core.management.load_command_class', HL),

    ('django.core.management.ManagementUtility.__init__', HL),

    ('django.core.management.ManagementUtility.autocomplete', HL),

    ('django.core.management.ManagementUtility.execute', HL),

    ('django.core.management.ManagementUtility.fetch_command', HL),

    ('django.core.servers.basehttp.get_internal_wsgi_application', HL),

    ('django.core.servers.basehttp.WSGIRequestHandler.get_environ', [
        HL, 'hide_below'
    ]),

    ('django.core.servers.basehttp.WSGIServer.__init__', HL),

    ('django.core.validators([.].+)?', False),

    ('django.core.wsgi.get_wsgi_application', HL),

    ('django.db([.].+)?', False),

    ('django.dispatch([.].+)?', False),

    ('django.forms([.].+)?', False),

    ('django.http.request.HttpRequest.__setattr__', False),

    ('django.http.request.HttpRequest.get_full_path', False),

    ('django.http.request.HttpRequest.read', HL),

    ('django.http.response.HttpResponse.__init__', HL),

    ('django.setup', HL),

    ('django.template([.].+)?', False),

    ('django.urls.base.set_script_prefix', HL),

    ('django.urls.base.set_urlconf', HL),

    ('django.urls.resolvers.get_resolver', HL),

    # Ignore to avoid error
    ('django.urls.resolvers.LocaleRegexProvider.__setattr__', False),

    ('django.urls.resolvers.RegexURLResolver.resolve', HL),

    # Ignore to avoid error
    ('django.urls.resolvers.ResolverMatch', False),

    ('django.utils.deprecation', False),

    # Ignore to avoid error
    ('django.utils.functional.LazyObject.__setattr__', False),

    # Ignore to avoid error
    ('django.utils.functional.Promise.__setattr__', False),

    # Ignore to avoid error
    ('django.utils.functional.SimpleLazyObject._setup', False),

    ('django.utils.functional([.].+)?', False),

    ('django.utils.log', True),

    ('django.utils.log.configure_logging', HL),

    # Ignore to avoid error
    ('django.utils.log.ServerFormatter', False),

    ('django.utils.six([.].+)?', False),

    ('django.utils.translation([.].+)?', False),

    ('django.utils.version([.].+)?', False),
    ...
    # ----- aoikdjangostudy -----
    ('aoikdjangostudy.views.CustomRequestHandler', HL),

    ('aoikdjangostudy([.].+)?', True),
